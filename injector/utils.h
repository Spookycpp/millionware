...
template <typename F>
inline auto wait_for_object( const F &function, std::chrono::steady_clock::duration interval = std::chrono::milliseconds( 250 ), std::chrono::steady_clock::duration time_out = std::chrono::seconds( 60 ) ) -> decltype( function( ) )
{
