...
const std::vector<item_definitions::item_name_t> item_definitions::knife_names = {
...
const std::vector<item_definitions::item_name_t> item_definitions::glove_names = {
...
const std::vector<item_definitions::quality_name_t> item_definitions::quality_names = {
	{ 0,  "Normal" },
	{ 1,  "Genuine" },
	{ 2,  "Vintage" },
