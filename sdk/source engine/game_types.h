...
enum e_game_type { GAME_TYPE_UNKNOWN = -1, GAME_TYPE_CLASSIC, GAME_TYPE_GUNGAME, GAME_TYPE_TRAINING, GAME_TYPE_CUSTOM, GAME_TYPE_COOPERATIVE, GAME_TYPE_SKIRMISH, GAME_TYPE_FREEFORALL };
