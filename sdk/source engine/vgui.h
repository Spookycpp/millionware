...
class c_vgui_surface {
  public:
    ...
    DECLARE_VFUNC(16, fill_rectangle(int x, int y, int width, int height), void(__thiscall *)(void *, int, int, int, int))(x, y, x + width, y + height);
    DECLARE_VFUNC(18, draw_rectangle(int x, int y, int width, int height), void(__thiscall *)(void *, int, int, int, int))(x, y, x + width, y + height);
    ...
    DECLARE_VFUNC(28, render_text(const wchar_t *string, int length, int flags), void(__thiscall *)(void *, const wchar_t *, int, int))(string, length, flags);
    ...
    DECLARE_VFUNC(72, set_font_glyph_set(uint32_t font, const char *font_name, int size, int weight, int flags), void(__thiscall *)(void *, uint32_t, const char *, int, int, int, int, int, int, int))(font, font_name, size, weight, 0, 0, flags, 0, 0);
    DECLARE_VFUNC(79, calculate_text_size(uint32_t font, const wchar_t *string, int &width, int &height), void(__thiscall *)(void *, uint32_t, const wchar_t *, int &, int &))(font, string, width, height);
    DECLARE_VFUNC(123, fill_faded_rectangle(int x, int y, int width, int height, int start_alpha, int end_alpha, bool horizontal), void(__thiscall *)(void *, int, int, int, int, int, int, bool))(x, y, x + width, y + height, start_alpha, end_alpha, horizontal);
