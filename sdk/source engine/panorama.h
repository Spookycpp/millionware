...
public:
	...
	DECLARE_VFUNC(113, run_script(c_ui_panel *root_panel, const char *js_code, const char *layout_file, int a1, int a2, bool a3, bool a4), void(__thiscall *)(void *, c_ui_panel *, const char *, const char *, int, int, bool, bool))(root_panel, js_code, layout_file, a1, a2, a3, a4);
};
