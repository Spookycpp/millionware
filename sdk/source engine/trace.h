...
{
public:
	DECLARE_VFUNC(0, get_point_contents(const vector_t &position, int contents_mask = MASK_ALL, c_entity **entity = nullptr), int(__thiscall *)(void*, const vector_t &, int, c_entity **))(position, contents_mask, entity);
	...
	DECLARE_VFUNC(3, clip_ray_to_entity(const ray_t &ray, int mask, c_entity *entity, c_base_trace *trace), void(__thiscall *)(void *, const ray_t &, int, c_entity *, c_base_trace *))(ray, mask, entity, trace);
	DECLARE_VFUNC(4, clip_ray_to_collideable(const ray_t &ray, int mask, vector_t *collideable, c_base_trace *trace), void(__thiscall *)(void *, const ray_t &, int, vector_t *, c_base_trace *))(ray, mask, collideable, trace);
	DECLARE_VFUNC(5, trace_ray(const ray_t &ray, int mask, c_base_trace_filter *filter, c_game_trace *trace), void(__thiscall *)(void *, const ray_t &, int, c_base_trace_filter *, c_game_trace *))(ray, mask, filter, trace);
};
