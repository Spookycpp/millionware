...
public:
	...
	VIRTUAL_METHOD(material_t*, find_material, 84, (std::string_view material_name, std::string_view group_name = "", bool complain = true, std::string_view complain_prefix = ""), SV_CHECK(material_name), SV_CHECK(group_name), complain, SV_CHECK(complain_prefix));
