...
#define STR_ENC_NO_DECRYPT(str) (::jm::xor_string([]() { return str; }, std::integral_constant<std::size_t, sizeof(str) / sizeof(*str)>{}, std::make_index_sequence<::jm::detail::_buffer_size<sizeof(str)>()>{}))
#define STR_ENC(str) (STR_ENC_NO_DECRYPT(str).crypt_get())
